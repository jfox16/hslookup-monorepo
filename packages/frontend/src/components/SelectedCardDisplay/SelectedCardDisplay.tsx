  ...
  return cardValues ? (
    <div className="SelectedCardDisplay">
      ...
      <div className="cardProperties">
        ...
        {cardValues.classes.length > 0 && <p>{pluralize('Class', cardValues.classes.length)}: <b>{cardValues.classes.join(', ')}</b></p>}
        ...
        {cardValues.keywords.length > 0 && <p>Keywords: <b>{cardValues.keywords.join(', ')}</b></p>}
        {cardValues.rarity && <p>Rarity: <b>{cardValues.rarity}</b></p>}
        {cardValues.minionTypes.length > 0 && <p>{pluralize('Minion Type', cardValues.minionTypes.length)}: <b>{cardValues.minionTypes.join(', ')}</b></p>}
